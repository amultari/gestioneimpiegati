									...
									<form:form modelAttribute="insert_impiegato_attr" method="post" action="save" class="row g-3" novalidate="novalidate">
										...
										<div class="col-md-6">
											...
											<spring:bind path="matricola">
												<input type="text" name="matricola" id="matricola" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire la matricola" value="${insert_impiegato_attr.matricola }" required>
											</spring:bind>
											<form:errors  path="matricola" cssClass="error_field" />
										</div>
										
										
										<fmt:parseDate value="${insert_impiegato_attr.dataDiNascita}" pattern="yyyy-MM-dd" var="localDateToBeParsed" type="date"/>
